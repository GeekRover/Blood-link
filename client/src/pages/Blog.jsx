                  ...
                  <div className="flex flex-col justify-between">
                    ...
                    <div className="flex justify-end" style={{ paddingTop: '1rem' }}>
                      <motion.button
                        ...
                        className="inline-flex items-center gap-2 rounded-lg bg-red-50 dark:bg-red-950/30 text-red-600 dark:text-red-400 font-semibold text-sm hover:bg-red-100 dark:hover:bg-red-950/50 transition-all duration-300 group/btn"
                        style={{ padding: '0.75rem 1.5rem', border: 'none', background: 'inherit', cursor: 'pointer' }}
                      >
                        <span>Read More</span>
